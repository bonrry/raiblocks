...
int run_wallet (QGuiApplication & application, int argc, char * const * argv, boost::filesystem::path const & data_path)
{
...
int main (int argc, char * const * argv)
{
    try
    {
        ...
        QGuiApplication application(argc, const_cast <char **> (argv));
